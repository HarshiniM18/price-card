      ...
      <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <hr />
            <ul className="fa-ul">
              <li className={props.value.userEnabler && props.value.highlight ? "fw-bold": ""}><span className="fa-li" ><i className={props.value.userEnabler? "fas fa-check": "fas fa-times"}></i></span>{props.value.user}</li>
              ...
              <li className={props.value.subDomainEnabler && props.value.subDomainHighlight ? "fw-bold": "text-muted"}><span className="fa-li"><i className={props.value.subDomainEnabler? "fas fa-check": "fas fa-times"}></i></span>{props.value.subDomain}</li>
